...
LONG CExceptionDump::UnhandledException(EXCEPTION_POINTERS *pException) {
    char modulefile[256];
    ...
    */
    ...
    snprintf(filename, sizeof(filename), "%s_%04d%02d%02d_%02d%02d%02d_%03d.dmp",
        modulefilename,
        st.wYear, st.wMonth, st.wDay, st.wHour, st.wMinute, st.wSecond, st.wMilliseconds);
