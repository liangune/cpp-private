...
int CLocaltime::getDaylightActive() 
{
    return daylightActive;
}

void CLocaltime::nolocksLocaltime(const time_t *timep, struct tm *result)
{
#ifndef _MSC_VER
    nolocks_localtime(result, *timep, getTimeZone(), daylightActive);
#endif
}